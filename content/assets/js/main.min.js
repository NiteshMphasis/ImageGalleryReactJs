...
var React=require("react");Pager=require("./Pager"),ThumbnailList=require("./ThumbnailList"),Search=require("./Search"),$=require("jquery"),module.exports=React.createClass({displayName:"exports",getInitialState:function(){return{stopFetching:!1,loading:!0,error:!1,page:1,data:[],search:"soccer"}},getDefaultProps:function(){return{config:{base_url:"https://api.flickr.com/services/rest/",per_page:10,search:"soccer",api_key:"4259ba9d328b8baa76efa6a0461cd8b6"}}},changePage:function(e){var t=this.state.stopFetching;e<this.state.page&&(t=!1),t||this.setState({stopFetching:t,loading:!0,error:!1,page:e})},loadImagesFromServer:function(){if(this.state.stopFetching)return!1;var e=this.props.config.base_url+"?method=flickr.photos.search&tags="+this.state.search+"&api_key="+this.props.config.api_key+"&page="+this.state.page+"&per_page="+this.props.config.per_page+"&format=json";$.ajax({url:e,type:"GET",dataType:"jsonp",cache:!1,jsonp:"jsoncallback",success:function(e){this.processData(e)}.bind(this),error:function(e,t,a){this.failedProcessingData(e,t,a)}.bind(this)})},processData:function(e){var t=!1,a=e.photos.photo;(!a||0==a.length||a.length<this.props.config.per_page)&&(t=!0),this.setState({stopFetching:t,loading:!1,error:!1,data:a})},failedProcessingData:function(e,t,a){this.setState({error:!0})},componentDidMount:function(e,t){this.loadImagesFromServer()},componentDidUpdate:function(e,t){return t.page==this.state.page&&t.search==this.state.search?!1:void this.loadImagesFromServer()},setSearchValue:function(e){e!=this.state.search&&this.setState({stopFetching:!1,loading:!0,error:!1,search:e,page:1})},render:function(){return this.state.error?React.createElement("div",{id:"image-gallery",className:"container"},React.createElement("div",{className:"row"},React.createElement("div",{className:"col-md-12"},React.createElement("p",null,"Error making request. Please try again later.")))):React.createElement("div",{id:"image-gallery",className:"container"},React.createElement("div",{className:"header"},React.createElement(Pager,{page:this.state.page,changePage:this.changePage,noNextPage:this.state.stopFetching}),React.createElement("h1",{className:"page-header"},"Gallery")),React.createElement(Search,{searchValue:this.state.search,setSearchValue:this.setSearchValue}),React.createElement(ThumbnailList,{images:this.state.data,loading:this.state.loading}))}});
...
var React=require("react"),Thumbnail=require("./Thumbnail");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{images:null,loading:!0}},flickrPhotoUrl:function(e,r){var a={small_square:"s",large_square:"q",thumbnail:"t",small_240:"m",small_320:"n",medium_640:"z",medium_800:"c",large_1024:"b",large_1600:"h",large_2048:"k",original:"o"},i=a[r];return"https://farm"+e.farm+".staticflickr.com/"+e.server+"/"+e.id+"_"+e.secret+"_"+i+".jpg"},render:function(){var e=this;if(this.props.loading||this.props.images&&this.props.images.length<1)return React.createElement("div",{className:"row imagelist"},React.createElement("div",{className:"col-md-12"},this.props.loading?"Loading...":"No images found"));if(this.props.images&&this.props.images.length){var r=this.props.images,e=this,a=r.map(function(r){var a=e.flickrPhotoUrl(r,"medium_800"),i=e.flickrPhotoUrl(r,"large_square");return React.createElement(Thumbnail,{imageUrl:a,thumbnailUrl:i,key:r.id})});return React.createElement("div",{className:"row imagelist"},a)}return null}});
...
var configs={base_url:"https://api.flickr.com/services/rest/",per_page:10,default_tag:"soccer",api_key:"4259ba9d328b8baa76efa6a0461cd8b6"},React=require("react"),App=require("./components/app");React.render(React.createElement(App,{config:configs}),document.body);
