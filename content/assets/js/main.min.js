...
var React=require("react");Pager=require("./Pager"),ThumbnailList=require("./ThumbnailList"),Search=require("./Search"),$=require("jquery"),module.exports=React.createClass({displayName:"exports",getInitialState:function(){return{stopFetching:!1,loading:!0,error:!1,page:1,data:[],search:null}},getDefaultProps:function(){return{config:{base_url:"https://api.flickr.com/services/rest/",per_page:10,api_key:"4259ba9d328b8baa76efa6a0461cd8b6"}}},changePage:function(e){var a=this.state.stopFetching;e<this.state.page&&(a=!1),a||this.setState({stopFetching:a,loading:!0,error:!1,page:e})},loadImagesFromServer:function(){if(this.state.stopFetching)return!1;var e=this.props.config.base_url+"?method=flickr.photos.search&safe_search=1&tags="+this.state.search+"&api_key="+this.props.config.api_key+"&page="+this.state.page+"&per_page="+this.props.config.per_page+"&format=json";$.ajax({url:e,type:"GET",dataType:"jsonp",cache:!1,jsonp:"jsoncallback",success:function(e){this.processData(e)}.bind(this),error:function(e,a,t){this.failedProcessingData(e,a,t)}.bind(this)})},processData:function(e){var a=!1,t=e.photos.photo;(!t||0==t.length||t.length<this.props.config.per_page)&&(a=!0),this.setState({stopFetching:a,loading:!1,error:!1,data:t})},failedProcessingData:function(e,a,t){this.setState({error:!0})},componentDidUpdate:function(e,a){return a.page==this.state.page&&a.search==this.state.search?!1:void this.loadImagesFromServer()},setSearchValue:function(e){e!=this.state.search&&this.setState({stopFetching:!1,loading:!0,error:!1,search:e,page:1})},render:function(){return this.state.error===!0?React.createElement("div",{id:"image-gallery",className:"container"},React.createElement("div",{className:"row"},React.createElement("div",{className:"col-md-12"},React.createElement("p",null,"Error making request. Please try again later.")))):null!==this.state.search?React.createElement("div",{id:"image-gallery",className:"container"},React.createElement("div",{className:"header"},React.createElement(Pager,{page:this.state.page,changePage:this.changePage,noNextPage:this.state.stopFetching}),React.createElement("h1",{className:"page-header"},"Gallery")),React.createElement(Search,{searchValue:this.state.search,setSearchValue:this.setSearchValue}),React.createElement(ThumbnailList,{images:this.state.data,loading:this.state.loading})):React.createElement("div",{id:"image-gallery",className:"container"},React.createElement("div",{className:"header"},React.createElement("h1",{className:"page-header"},"Gallery")),React.createElement(Search,{setSearchValue:this.setSearchValue}),React.createElement("p",{align:"center"},"What are you looking for? Use the search box above."))}});
},{"./Pager":159,"./Search":160,"./ThumbnailList":162,"jquery":2,"react":157}],159:[function(require,module,exports){
var React=require("react");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{noNextPage:!1,page:1}},handleNext:function(){this.props.changePage(this.props.page+1)},handlePrev:function(){var e=this.props.page-1;e>=0&&this.props.changePage(e)},render:function(){return 1==this.props.page?this.props.noNextPage?null:React.createElement("nav",null,React.createElement("ul",{className:"pager"},React.createElement("li",null,React.createElement("a",{href:"#",onClick:this.handleNext,className:"next-link"},"Next")))):this.props.noNextPage?React.createElement("nav",null,React.createElement("ul",{className:"pager"},React.createElement("li",null,React.createElement("a",{href:"#",onClick:this.handlePrev,className:"prev-link"},"Previous")))):React.createElement("nav",null,React.createElement("ul",{className:"pager"},React.createElement("li",null,React.createElement("a",{href:"#",onClick:this.handlePrev,className:"prev-link"},"Previous")),React.createElement("li",null,React.createElement("a",{href:"#",onClick:this.handleNext,className:"next-link"},"Next"))))}});
},{"react":157}],160:[function(require,module,exports){
var React=require("react");module.exports=React.createClass({displayName:"exports",handleSubmit:function(e){e.preventDefault();var t=React.findDOMNode(this.refs.search).value.trim();t&&this.props.setSearchValue(t)},render:function(){return React.createElement("div",{className:"searchbox"},React.createElement("form",{method:"post",className:"searchForm form-inline",onSubmit:this.handleSubmit,role:"form"},React.createElement("div",{className:"form-group"},React.createElement("input",{type:"text",className:"form-control",ref:"search",placeholder:"Search for photos...",name:"search"})," ",React.createElement("button",{type:"submit",className:"btn btn-default"},"Search"))))}});
},{"react":157}],161:[function(require,module,exports){
var React=require("react");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{imageUrl:null,thumbnailUrl:null}},render:function(){return React.createElement("div",{className:"col-lg-3 col-md-3 col-xs-6 thumb"},React.createElement("a",{className:"thumbnail fancybox",href:this.props.imageUrl},React.createElement("img",{className:"img-responsive",src:this.props.thumbnailUrl})))}});
},{"react":157}],162:[function(require,module,exports){
var React=require("react"),Thumbnail=require("./Thumbnail");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{images:null,loading:!0}},flickrPhotoUrl:function(e,r){var a={small_square:"s",large_square:"q",thumbnail:"t",small_240:"m",small_320:"n",medium_640:"z",medium_800:"c",large_1024:"b",large_1600:"h",large_2048:"k",original:"o"},i=a[r];return"https://farm"+e.farm+".staticflickr.com/"+e.server+"/"+e.id+"_"+e.secret+"_"+i+".jpg"},render:function(){var e=this;if(this.props.loading||!this.props.images||this.props.images&&this.props.images.length<1)return React.createElement("div",{className:"row imagelist"},React.createElement("div",{className:"col-md-12"},this.props.loading?"Loading...":"No images were found."));if(this.props.images&&this.props.images.length){var r=this.props.images,e=this,a=r.map(function(r){var a=e.flickrPhotoUrl(r,"medium_800"),i=e.flickrPhotoUrl(r,"large_square");return React.createElement(Thumbnail,{imageUrl:a,thumbnailUrl:i,key:r.id})});return React.createElement("div",{className:"row imagelist"},a)}return null}});
},{"./Thumbnail":161,"react":157}],163:[function(require,module,exports){
var React=require("react"),Gallery=require("./Gallery");module.exports=React.createClass({displayName:"exports",getInitialState:function(){return{pageToRender:"home",paramsForPage:{}}},transitionTo:function(e,t){return e==this.state.pageToRender?!1:void this.setState({pageToRender:e,paramsForPage:t})},render:function(){var e=this.state.pageToRender;return"function"==typeof this[e]?this[e](this.state.paramsForPage):this.home()},home:function(e){return React.createElement(Gallery,{config:this.props.config,transitionTo:this.transitionTo})}});
},{"./Gallery":158,"react":157}],164:[function(require,module,exports){
var configs={base_url:"https://api.flickr.com/services/rest/",per_page:10,api_key:"4259ba9d328b8baa76efa6a0461cd8b6"},React=require("react"),App=require("./components/app");React.render(React.createElement(App,{config:configs}),document.body);
},{"./components/app":163,"react":157}]},{},[164]);
