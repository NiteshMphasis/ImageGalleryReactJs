...
var React=require("react");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{imageUrl:null,thumbnailUrl:null}},render:function(){return React.createElement("div",{className:"col-lg-2 col-md-3 col-xs-6 thumb"},React.createElement("a",{className:"thumbnail fancybox",href:this.props.imageUrl},React.createElement("img",{className:"img-responsive",src:this.props.thumbnailUrl})))}});
},{"react":157}],162:[function(require,module,exports){
var React=require("react"),Thumbnail=require("./Thumbnail");module.exports=React.createClass({displayName:"exports",getDefaultProps:function(){return{images:null,loading:!0}},flickrPhotoUrl:function(e,a){var r={small_square:"s",large_square:"q",thumbnail:"t",small_240:"m",small_320:"n",medium_640:"z",medium_800:"c",large_1024:"b",large_1600:"h",large_2048:"k",original:"o"},i=r[a];return"https://farm"+e.farm+".staticflickr.com/"+e.server+"/"+e.id+"_"+e.secret+"_"+i+".jpg"},render:function(){var e=this;if(this.props.loading||this.props.images.length<1)return React.createElement("div",{className:"row imagelist"},React.createElement("div",{className:"col-md-12"},this.props.loading?"Loading...":"No images found"));if(this.props.images&&this.props.images.length){var a=this.props.images,e=this,r=a.map(function(a){var r=e.flickrPhotoUrl(a,"medium_800"),i=e.flickrPhotoUrl(a,"large_square");return React.createElement(Thumbnail,{imageUrl:r,thumbnailUrl:i,key:a.id})});return React.createElement("div",{className:"row imagelist"},r)}}});
